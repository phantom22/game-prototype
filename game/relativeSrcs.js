  ...
  tScript.onload = function() {
    ...
    lScript.onload = function() {
      ...
      gScript.onload = function() {
        ...
        instance = new gameInstance({position:true,moves:1,vision:{initialRange:l[a[0]].range,tokensPerRangeLoss:l[a[0]].loss,maxRange:l[a[0]].range+2,minRange:2},gamemode:l[a[0]].gamemode},{grid:l[a[1]].grid,meta:`${l[a[1]].meta}`,bannedTilesFromRandomizing:l[a[1]].bannedTilesFromRandomizing,madness:{minRangeMovesBeforeActivation:5,loss:-0.075,gain:0.007,coins:{true:{negativeMadnessMultiplier:2.5,positiveMadnessMultiplier:0.8},false:{negativeMadnessMultiplier:1.5,positiveMadnessMultiplier:0.9}}},coins:{true:{quantity:10,tokenRewards:{base:"*1.2",random:{added:[3,"*1.5 +1"],removed:[1,"*1.5 -3"]}}},false:{quantity:10,tokenRewards:{base:"*0.5",random:{added:[3,"*0.8 +1"],removed:[1,"*0.8 -2"]}}}}});
